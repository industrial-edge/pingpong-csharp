...
- [Configuring and deploying the application to a Industrial Edge Device](#configuring-and-deploying-the-application-to-a-industrial-edge-device)
  - [Configuring the application via file upload (UseCase 1)](#configuring-the-application-via-file-upload-usecase-1)
  - [Configuring the application via custom UI (UseCase 2)](#configuring-the-application-via-custom-ui-usecase-2)
